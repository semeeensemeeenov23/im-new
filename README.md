...
![Framer Motion](https://img.shields.io/badge/Framer_Motion-10.16-pink)
...
|-----------------|-------------------|
| ![Главная](./public/screenshots/homepage.png) | ![Для кого курс](./public/screenshots/target.png) |

| Программа курса | Отзывы |
|-----------------|--------|
| ![Программа](./public/screenshots/program.png) | ![Отзывы](./public/screenshots/reviews.png) |

| До/После | Форма записи |
|----------|-------------|
| ![До/После](./public/screenshots/gallery.png) | ![Форма](./public/screenshots/form.png) |

### Мобильная версия

| Главная (мобильная) | Программа (мобильная) |
|---------------------|----------------------|
| ![Мобильная главная](./public/screenshots/mobile-home.png) | ![Мобильная программа](./public/screenshots/mobile-program.png) |
